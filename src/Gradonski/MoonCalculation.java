...
public class MoonCalculation {
   ...
   private static final String moon_phase_name[] = { "Neumond",
                                                     "Zunehmender Sichel",
                                                     "Halbmond",
                                                     "Zunehmender Mond",
                                                     "Voll Mond",
 ...
 BufferedImage phaseIcon(int phase) throws IOException{
	   String current = new java.io.File( "." ).getCanonicalPath();
	      return image = ImageIO.read(new File(current + "/src/Gradonski/images/"+ phase +".jpg"));
   }
